...
Получилась некая проблема: я сразу сделала правильно и ввела git pull, чего делать не следовало. Поэтому пришлось еще раз заменить k=3 (в гитхабе) и добавить print в конце (с ПК). В итоге git push выдал ошибку
